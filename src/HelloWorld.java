...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
		size(1200, 900, P2D);  // Set up the Applet window to be 800x600
...
//		AbstractMapProvider provider = new Microsoft.RoadProvider();
		...
		map1 = new UnfoldingMap(this, 10, 10, 580, 880, provider);
		map2 = new UnfoldingMap(this, 610, 10, 580, 880, provider);
